...
public class UmmalquraDateFormatTests {
	...
	public void formatWithEnglishLocale() {
		...
		assertEquals("{1436,5,23} should format to 'Jum-I 23, 1436' using 'MMM d, y'", "Jum-I 23, 1436",
						formatDate(en, "MMM d, y"));

		assertEquals("{1436,5,23} should format to 'Jumada al-Ula 23, 1436' using 'MMMM d, y'", "Jumada al-Ula 23, 1436",
						formatDate(en, "MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'Sat, Jumada al-Ula 23, 1436' using 'E, MMMM d, y'", "Sat, Jumada al-Ula 23, 1436",
						formatDate(en, "E, MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'Saturday, Jumada al-Ula 23, 1436' using 'EEEE, MMMM d, y'", "Saturday, Jumada al-Ula 23, 1436",
						formatDate(en, "EEEE, MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'Saturday, Jumada al-Ula 23, 36' using 'EEEE, MMMM d, yy'", "Saturday, Jumada al-Ula 23, 36",
						formatDate(en, "EEEE, MMMM d, yy"));

		assertEquals("Should format to 'Saturday, Jumada al-Ula 23, 36 12:19:44' using 'EEEE, MMMM d, yy hh:mm:ss'", "Saturday, Jumada al-Ula 23, 36 12:19:44",
	...
	public void formatWithArabicLocale() {
		...
		assertEquals("{1436,5,23} should format to 'جمادى 1 23, 1436' using 'MMM d, y'", "جمادى 1 23, 1436",
						formatDate(ar, "MMM d, y"));

		assertEquals("{1436,5,23} should format to 'جمادى الأولى 23, 1436' using 'MMMM d, y'", "جمادى الأولى 23, 1436",
						formatDate(ar, "MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'س, جمادى الأولى 23, 1436' using 'E, MMMM d, y'", "س, جمادى الأولى 23, 1436",
						formatDate(ar, "E, MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'السبت, جمادى الأولى 23, 1436' using 'EEEE, MMMM d, y'", "السبت, جمادى الأولى 23, 1436",
						formatDate(ar, "EEEE, MMMM d, y"));

		assertEquals("{1436,5,23} should format to 'السبت, جمادى الأولى 23, 36' using 'EEEE, MMMM d, yy'", "السبت, جمادى الأولى 23, 36",
	...
	public void parseWithEnglishLocale() throws ParseException {
		...
		uCal = parseDate("Saturday, Jumada al-Ula 23, 36 12:19:44", "EEEE, MMMM d, yy hh:mm:ss", en);
		assertEquals("'Saturday, Jumada al-Ula 23, 36 12:19:44' should parse using 'EEEE, MMMM d, yy hh:mm:ss' format",
						"1436-5-23",
						String.format("%d-%d-%d", uCal.get(Calendar.YEAR), uCal.get(Calendar.MONTH) + 1, uCal.get(Calendar.DAY_OF_MONTH)));
	...
	private UmmalquraCalendar parseDate(String dateText, String fmt, Locale l) throws ParseException {
